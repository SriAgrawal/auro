...
let webApiBaseURL = "http://ec2-52-74-218-145.ap-southeast-1.compute.amazonaws.com:9000/"
...
class ServiceHelper: NSObject {
    ...
    class func request(params: [String: Any], method: MethodType, apiName: String, hudType: loadingIndicatorType, completionBlock: @escaping (AnyObject?, Error?, Int) -> Void) ->Void {
        ...
        request.perform(hudType: hudType) { (responseObject: AnyObject?, error: Error?, httpResponse: HTTPURLResponse?) in
            ...
            DispatchQueue.main.async(execute: {
                ...
                guard let httpResponse = httpResponse else {
                    ...
                    completionBlock(responseObject, error, 9999)
                    return
                }
    ...
    class func multiPartRequest(params: [String: Any], method: MethodType, apiName: String, hudType: loadingIndicatorType, mediaArray: Array<Dictionary<String, AnyObject>>, isUsingFilePathUpload: Bool, completionBlock: @escaping (AnyObject?, Error?, Int) -> Void) ->Void {
...
extension URLRequest  {
    ...
    func perform(hudType: loadingIndicatorType, completionBlock: @escaping (AnyObject?, Error?, HTTPURLResponse?) -> Void) -> Void {
        ...
        if (APPDELEGATE.isReachable == false) {
            AlertController.alert("Connection Error!", message: "Internet connection appears to be offline. Please check your internet connection.")
            return
        }
